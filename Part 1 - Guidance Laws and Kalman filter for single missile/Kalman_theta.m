function [ t,xm,ym,xt,yt,rho,vc,nc,t_go ] = Kalman_theta( param,method,manuver,tau,theta_true,theta,dt,xt0,yt0,xm0,ym0,vm,vt,HE,gamma_t0,nt_amp,w,phase,flag,maxnc,sigmas,delta_sigma,at_sigma,w_sigma )
...
while (i==1||abs(rho(i))<=abs(rho(i-1)))&&t(i)<=15
    ...
    x_n_n=x_n_n1+K_n*(y_n_mes-[del_m_est(i);at_est(i)]);
