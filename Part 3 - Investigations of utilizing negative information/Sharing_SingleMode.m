function [t,xm,ym,xt,yt,nc,miu,miss] = Sharing_SingleMode(xm0,ym0,tau,am_max,vm,k,xt0,yt0,theta,at_max,T_sw,vt,gamma_t0,xr,yr,dt,Dt,Nmis,sigmas,delta_m_sig,noise_int,noise_mes,pi_mat,Q_n,DB,h,S_miss1_mean,S_miss1_SD,Q_n_red)
% Inputs: 
