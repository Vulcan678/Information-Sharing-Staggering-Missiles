function [ t,xm,ym,xt,yt,rho,vc,nc,t_go ] = Semi_Ideal (param,method,manuver,tau,dt,xt0,yt0,xm0,ym0,vm,vt,HE,gamma_t0,nt_amp,w,phase,flag,maxnc )
% Semi Ideal: method can't be {4,6,7,9}
% Inputs: 
...
nc(i)=nc_calc(t_go(i), t_go(i)+t(i), tau, 0, am_n(i), at_n(i), v_rho(i), dlambda(i), del_m(i), param, flag, maxnc, method);
